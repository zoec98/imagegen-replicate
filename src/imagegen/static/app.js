...
(function() {
	...
	(() => {
		...
		async function loadEditorFragment() {
			...
			const data = await requestJson(paletteUrl(`/${encoded(paletteEditorPalette.value)}/fragments/${encoded(paletteEditorFragment.value)}`), { fallbackMessage: "Palette fragment could not be loaded." });
